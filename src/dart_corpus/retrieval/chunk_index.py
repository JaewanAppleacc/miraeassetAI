...
SECTION_RULES: dict[str, tuple[str, ...]] = {
    ...
    # 자기주식 취득/소각의 실제 기록은 "주주에 관한 사항"이 아니라 I. 회사의 개요 밑에
    # 있다 — 소각 이력은 "자본금 변동사항", 신탁계약 체결/연장/해지 경과는 "회사의 연혁"
    # 이다. 두 섹션이 어느 그룹에도 없어 gold 청크의 sec_hit이 0이었다(Q09 rank 124,
    # Q21 rank 304). 14차 실험에서 이 두 이름만 추가해 E-R@20 0.9143 -> 0.9357.
